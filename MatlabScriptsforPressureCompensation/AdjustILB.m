...
ILBStage_2022 = synchronize(TT7,TT3,'regular','mean','TimeStep',minutes(15));
ILBStage_2022.Compensated = (ILBStage_2022.ILB/100 - ILBStage_2022.Baro*10.1972);
